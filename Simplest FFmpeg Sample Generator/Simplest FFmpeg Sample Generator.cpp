// Simplest FFmpeg Sample Generator.cpp : 定义控制台应用程序的入口点。
//


/**
* 最简单的 FFmpeg 测试样例生成工具
* Simplest FFmpeg Sample Generator
*
* 源程序：
* 雷霄骅 Lei Xiaohua
...
* 颜色视频      [RGB24][YUV444P]
*
* This software can generate several samples that used for test:
...
{
	// 灰阶测试图
	//gen_yuv420p_graybar(1280, 720, 10, 16, 235); // 亮度取值范围为 16-235
	//gen_yuv420p_graybar(1280, 720, 10, 0, 255); // 亮度取值范围为 0-255
	// 彩色测试条
